...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {/* District Test Papers Library & Summary Reports Section */}
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-4">
          <div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">
              ...
              Published Test Papers & Graphical Summary Reports
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Manage saved assessments, view graphical / text analytics reports, or edit test papers post-publishing.
            </p>
          </div>

          <button
            onClick={onNavigateToUpload}
            className="px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs sm:text-sm shadow-md shadow-emerald-600/20 transition-all flex items-center gap-2 self-start sm:self-auto hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        {tests.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {tests.map((test) => {
              ...
              return (
                <div
                  key={test.id}
                  className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex flex-col justify-between space-y-4 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all"
                >
                  <div>
                    ...
                    <h4 className="text-base font-extrabold text-slate-900 dark:text-white line-clamp-1">{test.title}</h4>

                    {/* Test Access Code Badge */}
                    ...
                    {/* Candidate Assignment Scope Badge */}
                    ...
                    <div className="grid grid-cols-3 gap-2 my-3 p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-[11px] text-center">
                      <div>
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-slate-200 dark:border-slate-800">
                      ...
                      {onEditTest && (
                        <button
                          ...
                          className="px-3 py-2 rounded-xl bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-bold text-xs transition-all flex items-center justify-center gap-1.5"
                        >
                      ...
                      {onDeleteTest && (
                        <button
                          ...
                          className="px-3 py-2 rounded-xl bg-rose-50 dark:bg-rose-950/60 hover:bg-rose-100 dark:hover:bg-rose-900/80 text-rose-600 dark:text-rose-400 font-bold text-xs transition-all flex items-center justify-center gap-1.5 border border-rose-200 dark:border-rose-800 hover:scale-[1.02] active:scale-[0.98]"
          ...
          <div className="p-8 text-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl text-slate-500 text-xs space-y-3">
            <p className="font-semibold">No test papers published yet.</p>
            <button
              onClick={onNavigateToUpload}
              className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs shadow transition-all inline-flex items-center gap-1.5"
            >
              <BookOpen className="w-4 h-4" />
              <span>+ Create New Test Paper</span>
            </button>
