...
import { Users, UserPlus, Search, Filter, Mail, Shield, CheckCircle2, XCircle, Key, RefreshCw, Send, AlertCircle } from 'lucide-react';
  ...
  const handleCreateCandidate = async (e: React.FormEvent) => {
    ...
    if (sendCredentialsEmail) {
      try {
        ...
        setActionFeedback(`Candidate account created! Resend login email dispatched to ${email}`);
      } catch (err) {
